...
# Depends on the tool too: a mapjson change (e.g. a new MapHeaderLocationData field)
# must regenerate every map's incs, or stale ones desync from the C struct layout.
