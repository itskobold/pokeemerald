...
const u8 gText_Var2IVRaised[] = _("{STR_VAR_1}'s {STR_VAR_2} IV was raised.{PAUSE_UNTIL_PRESS}");
const u8 gText_AbilitySwapped[] = _("{STR_VAR_1}'s ability was\nswapped.{PAUSE_UNTIL_PRESS}");
const u8 gText_TypesRandomized[] = _("{STR_VAR_1}'s types were\nrandomized.{PAUSE_UNTIL_PRESS}");
const u8 gText_AbilityRandomized[] = _("{STR_VAR_1}'s ability was\nrandomized.{PAUSE_UNTIL_PRESS}");
const u8 gText_NatureRandomized[] = _("{STR_VAR_1}'s nature was\nrandomized.{PAUSE_UNTIL_PRESS}");
const u8 gText_HiddenTypeChanged[] = _("{STR_VAR_1}'s hidden type\nwas changed.{PAUSE_UNTIL_PRESS}");
const u8 gText_MonWasMoved[] = _("{STR_VAR_1} was moved\ninto the {STR_VAR_2}.{PAUSE_UNTIL_PRESS}");
const u8 gText_ExpRaised[] = _("{STR_VAR_1}'s EXP. points were\nraised.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_BallSwapConfirm[] = _("Change BALL? Its current one will be lost.");
...
const u8 gText_BikeMode[] = _("BIKE MODE");
const u8 gText_FullParty[] = _("FULL PARTY");
const u8 gText_BattleStyle[] = _("BATTLE STYLE");
const u8 gText_BattleScene[] = _("BATTLE SCENE");
const u8 gText_QuickFlee[] = _("QUICK FLEE");
const u8 gText_Keyboard[] = _("KEYBOARD");
const u8 gText_Font[] = _("FONT");
const u8 gText_Frame[] = _("FRAME");
const u8 gText_LowHPSound[] = _("LOW HP SOUND");
const u8 gText_KeypadSound[] = _("KEYPAD SOUND");
const u8 gText_SoundOutput[] = _("SOUND OUTPUT");
const u8 gText_ResetDefaults[] = _("RESET DEFAULT OPTIONS");
const u8 gText_DowngradeToHardlockeMode[] = _("DOWNGRADE TO HARDLOCKE MODE");
const u8 gText_DowngradeToNuzlockeMode[] = _("DOWNGRADE TO NUZLOCKE MODE");
const u8 gText_DisableNuzlockeMode[] = _("DISABLE NUZLOCKE MODE");
const u8 gText_FreezeNuzlockeMode[] = _("FREEZE NUZLOCKE MODE");
const u8 gText_OptionMenuCancel[] = _("CLOSE MENU");

const u8 gText_BikeModeDescription[] = _("Controls how the bike is\nused in the overworld.");
const u8 gText_FullPartyDescription[] = _("Allows a party member to be sent to\nthe PC in place of a caught POKéMON.");
const u8 gText_FullPartyDeadlockeDescription[] = _("This option cannot be changed\nin a Deadlocke game.");
const u8 gText_BattleStyleDescription[] = _("Allows POKéMON to be recalled\nbefore the next foe is sent out.");
const u8 gText_BattleStyleNuzlockeDescription[] = _("This option cannot be changed\nin a Nuzlocke game.");
const u8 gText_BattleSceneDescription[] = _("Enable or disable graphics and\nsound effects in battle.");
const u8 gText_QuickFleeDescription[] = _("Allows fleeing from wild battles\nbefore a POKéMON is sent out.");
const u8 gText_FontDescription[] = _("Changes the text style.");
const u8 gText_LowHPSoundDescription[] = _("Toggles the beeping sound when a\nPOKéMON is at low HP in battle.");
const u8 gText_KeypadSoundDescription[] = _("Enables or disables many\nsound effects in menus.");
const u8 gText_SoundOutputDescription[] = _("Controls how audio is\noutput from the game.");
const u8 gText_KeyboardDescription[] = _("Changes the keyboard layout\non the naming screen.");
const u8 gText_FrameDescription[] = _("Changes the border of many\ntext boxes and menus.");
const u8 gText_ResetDefaultsDescription[] = _("Returns options to the\ndefault settings.");
const u8 gText_DisableNuzlockeModeDescription[] = _("Turn Nuzlocke mode off entirely,\nrestoring normal gameplay.");
const u8 gText_DowngradeToHardlockeModeDescription[] = _("Lowers Nuzlocke difficulty from\nDeadlocke to Hardlocke mode.");
const u8 gText_DowngradeToNuzlockeModeDescription[] = _("Lowers Nuzlocke difficulty from\nHardlocke to Nuzlocke mode.");
const u8 gText_FreezeNuzlockeModeDescription[] = _("Removes the ability to lower\nNuzlocke mode difficulty.");
const u8 gText_CancelDescription[] = _("Save settings and\nreturn to the game.");
const u8 gText_AreYouSure[] = _("Are you sure?\nThis action can't be undone.");

const u8 gKeyboardText_QWERTY[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}{LEFT_ARROW} QWERTY {RIGHT_ARROW}");
const u8 gKeyboardText_QWERTYPlus[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}{LEFT_ARROW} QWERTY+ {RIGHT_ARROW}");
const u8 gKeyboardText_ABC[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}{LEFT_ARROW} ABC {RIGHT_ARROW}");
const u8 gKeyboardText_ABCPlus[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}{LEFT_ARROW} ABC+ {RIGHT_ARROW}");
const u8 gKeyboardText_AZERTY[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}{LEFT_ARROW} AZERTY {RIGHT_ARROW}");
const u8 gKeyboardText_AZERTYPlus[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}{LEFT_ARROW} AZERTY+ {RIGHT_ARROW}");
const u8 gKeyboardText_Dvorak[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}{LEFT_ARROW} DVORAK {RIGHT_ARROW}");
const u8 gKeyboardText_DvorakPlus[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}{LEFT_ARROW} DVORAK+ {RIGHT_ARROW}");
const u8 gKeyboardText_Colemak[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}{LEFT_ARROW} COLEMAK {RIGHT_ARROW}");
const u8 gKeyboardText_ColemakPlus[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}{LEFT_ARROW} COLEMAK+ {RIGHT_ARROW}");
const u8 gKeyboardText_Vanilla[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}{LEFT_ARROW} VANILLA {RIGHT_ARROW}");
	
const u8 gFontText_Rocket[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}{LEFT_ARROW} ROCKET {RIGHT_ARROW}");
const u8 gFontText_Magma[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}{LEFT_ARROW} MAGMA {RIGHT_ARROW}");
const u8 gFontText_Aqua[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}{LEFT_ARROW} AQUA {RIGHT_ARROW}");
const u8 gFontText_Galactic[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}{LEFT_ARROW} GALACTIC {RIGHT_ARROW}");

const u8 gText_On[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}ON");
const u8 gText_Off[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}OFF");
const u8 gText_HoldB[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}HOLD B");
const u8 gText_Auto[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}AUTO");
const u8 gText_SwapPC[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}SWAP");
const u8 gText_SendToPC[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}SEND TO PC");
