...
static const u16 gUnknown_08613F34[] = {ITEM_BRIGHT_POWDER, ITEM_BITTER_HERB, ITEM_QUICK_CLAW, ITEM_LEFTOVERS, ITEM_PERSIM_BERRY, ITEM_KINGS_ROCK, ITEM_FOCUS_BAND, ITEM_SCOPE_LENS, ITEM_CHOICE_BAND};
