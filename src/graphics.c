...
const u32 gMonCommonPalette_CircledQuestionMark[] = INCBIN_U32("graphics/pokemon/circled_question_mark/common.gbapal.lz");
const u32 gMonUncommonPalette_CircledQuestionMark[] = INCBIN_U32("graphics/pokemon/circled_question_mark/uncommon.gbapal.lz");
const u32 gMonLesserPalette_CircledQuestionMark[] = INCBIN_U32("graphics/pokemon/circled_question_mark/lesser.gbapal.lz");
const u32 gMonRarePalette_CircledQuestionMark[] = INCBIN_U32("graphics/pokemon/circled_question_mark/rare.gbapal.lz");
const u32 gMonElitePalette_CircledQuestionMark[] = INCBIN_U32("graphics/pokemon/circled_question_mark/elite.gbapal.lz");
const u32 gMonExoticPalette_CircledQuestionMark[] = INCBIN_U32("graphics/pokemon/circled_question_mark/exotic.gbapal.lz");
...
const u8 gMonIcon_QuestionMark[] = INCBIN_U8("graphics/pokemon/double_question_mark/icon.4bpp");
const u8 gMonFootprint_QuestionMark[] = INCBIN_U8("graphics/pokemon/double_question_mark/footprint.1bpp");
