...
bool8 CameraMove(int x, int y)
{
    ...
    // A detached camera (freecam, track, or pan) slides across the seam without the player-only
    // connection transition (music/map-name/script/warp); the player stays parked at home.
