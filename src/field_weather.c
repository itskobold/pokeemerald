...
// Mutable (EWRAM) so DOWP can set OBJ palette color-maps as they're dynamically loaded.
...
// Sets the weather color-map type for a dynamically-allocated OBJ palette slot (DOWP).
// index is the OBJ palette slot (0-15); the sprite palettes occupy entries 16-31.
