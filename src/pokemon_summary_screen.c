...
static bool8 ExtractMonDataToSummaryStruct(struct Pokemon *mon)
{
    ...
    case 0:
		...
		sum->type1 = GetMonData(mon, MON_DATA_TYPE_1);
		sum->type2 = GetMonData(mon, MON_DATA_TYPE_2);
...
static void PrintMonAbilityName(void)
{
    u16 ability = GetAbilityBySpecies(sMonSummaryScreen->summary.species, sMonSummaryScreen->summary.altAbility, sMonSummaryScreen->summary.ability);
