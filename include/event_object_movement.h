...
// True when the object is drawn behind terrain (BEHIND band / obscured / hidden effects). Under-bridge
// objects are on the cliff plane for collision but render normally, so they are excluded here.
