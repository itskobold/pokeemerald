...
enum {
    ...
    MB_DEEP_SOUTH_WARP,
    MB_UNUSED_6F,
    MB_UNUSED_70,            // freed MB_BRIDGE (was MB_BRIDGE_OVER_OCEAN / Union Room spin-warp); bridges now use per-tile bridge data
    MB_UNUSED_71,            // freed MB_BRIDGE_OVER_POND_LOW
    MB_UNUSED_72,            // freed MB_BRIDGE_OVER_POND_MED
    MB_UNUSED_73,            // freed MB_BRIDGE_OVER_POND_HIGH
    ...
    MB_FORTREE_BRIDGE,
    MB_UNUSED_79,
    MB_UNUSED_7A,            // freed MB_BRIDGE_OVER_POND_MED_EDGE_1
    MB_UNUSED_7B,            // freed MB_BRIDGE_OVER_POND_MED_EDGE_2
    MB_UNUSED_7C,            // freed MB_BRIDGE_OVER_POND_HIGH_EDGE_1
    MB_UNUSED_7D,            // freed MB_BRIDGE_OVER_POND_HIGH_EDGE_2
    MB_UNUSED_BRIDGE,
