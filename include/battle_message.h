...
extern const u8 gText_StatSharplyRose[];
extern const u8 gText_StatWasMaximized[];
extern const u8 gText_PkmnsStatChanged2[];
extern const u8 gText_DireHit[];
extern const u8 gText_GuardSpec[];
extern const u8 sText_MoveFirst[];
extern const u8 sText_StatsReset[];
