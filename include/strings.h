...
extern const u8 gText_FullPartyDeadlockeDescription[];
extern const u8 gText_BattleStyleDescription[];
extern const u8 gText_BattleStyleNuzlockeDescription[];
...
extern const u8 gText_Var2IVRaised[];
extern const u8 gText_AbilitySwapped[];
extern const u8 gText_TypesRandomized[];
extern const u8 gText_AbilityRandomized[];
extern const u8 gText_NatureRandomized[];
extern const u8 gText_HiddenTypeChanged[];
extern const u8 gText_MonWasMoved[];
extern const u8 gText_ExpRaised[];
...
extern const u8 gText_BallSwapConfirm[];
